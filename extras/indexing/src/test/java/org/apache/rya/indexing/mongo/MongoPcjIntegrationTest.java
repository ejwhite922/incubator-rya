...
import org.apache.rya.indexing.mongodb.pcj.PcjQueryNode;
...
public class MongoPcjIntegrationTest extends MongoTestBase {
    ...
    public void testEvaluateTwoIndexValidate() throws Exception {
        ...
        try {
            ...
            PcjIntegrationTestingUtil.createAndPopulatePcj(conn, getMongoClient(), conf.getMongoDBName() + 1, conf.getRyaInstanceName(), indexSparqlString);
            final PcjQueryNode ais1 = new PcjQueryNode(conf, conf.getMongoDBName() + 1);
            ...
            final PcjQueryNode ais2 = new PcjQueryNode(conf, conf.getMongoDBName() + 2);
    ...
    public void testEvaluateThreeIndexValidate() throws Exception {
        ...
        try {
            ...
            final PcjQueryNode ais3 = new PcjQueryNode(conf, conf.getMongoDBName() + 3);
